...
QUESTION_DETAILS = {
    ...
    "mobile_number": {
        "text": "What's your mobile number? (With country code, e.g., +919876543210)",
        "type": "text",
    },
    "email": {"text": "What's your email address?", "type": "text"},
    "date_of_birth": {
        "text": "What's your date of birth? (DD/MM/YYYY)",
        "type": "date",
    },
    ...
    "cibil_score": {"text": "What's your CIBIL score?", "type": "text"},
    "pan": {
